export const LAYOUT = {
  ...
  OFF_METRICS: 128,
  OFF_TRI_IN: 256,
  OFF_TRI_OUT: 16800256,      // 256 + MAX_TRIS*48
  OFF_LEAVES: 33600256,       // OFF_TRI_OUT + MAX_TRIS*48
  OFF_GRASS: 33602304,        // OFF_LEAVES + MAX_LEAVES*32
  OFF_CREATURES: 33666304,    // OFF_GRASS + MAX_GRASS*32
  TRI_STRIDE: 48,
  LEAF_STRIDE: 32,
  GRASS_STRIDE: 32,
  CREATURE_STRIDE: 32,
  ...
  OFF_HORROR_CFG: 33672000,
  OFF_HORROR_ENT: 33672032,
  OFF_HORROR_SEG: 33672544,
  MAX_HORROR_ENT: 8,
  MAX_HORROR_SEG: 512,
