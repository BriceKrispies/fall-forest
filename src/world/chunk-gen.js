...
const SLOPE_PEAK = [0.26, 0.26, 0.24];
const SLOPE_COLORS = [SLOPE_BASE, SLOPE_MID, SLOPE_UPPER, SLOPE_RIDGE, SLOPE_TOP, SLOPE_PEAK];
...
export function generateChunk(worldSeed, coord, chunkDepth) {
  ...
  // Valley walls — slopes rising from inner edge to outer ridge
  // Right wall needs flipped winding so normals face inward toward player
  tris.push(...makeWallSection(-8, zMin, -8, zMax, -1, 0, false));
  tris.push(...makeWallSection(8, zMin, 8, zMax, 1, 0, true));
